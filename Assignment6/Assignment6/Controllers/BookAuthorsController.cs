...
namespace Assignment6.Controllers
{
    ...
    {
        private readonly Assign6DbContext _context;

        public BookAuthorsController(Assign6DbContext context)
        {
            _context = context;
        }
        ...
        {
            var assign6DbContext = _context.BookAuthors.Include(b => b.Author).Include(b => b.Book);
            return View(await assign6DbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Assign6DbContext.BookAuthors'  is null.");
            }
            var bookAuthor = await _context.BookAuthors.FindAsync(id);
            if (bookAuthor != null)
            {
